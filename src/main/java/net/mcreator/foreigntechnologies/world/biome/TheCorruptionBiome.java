...
public class TheCorruptionBiome {
	public static final Climate.ParameterPoint PARAMETER_POINT = new Climate.ParameterPoint(Climate.Parameter.span(0.261904761905f, 0.404761904763f),
			Climate.Parameter.span(-1.071428571429f, -0.928571428571f), Climate.Parameter.span(0.428571428571f, 0.571428571429f),
			Climate.Parameter.span(0.928571428571f, 1.071428571429f), Climate.Parameter.point(0),
			Climate.Parameter.span(0.760058440914f, 0.902915583772f), 0);
