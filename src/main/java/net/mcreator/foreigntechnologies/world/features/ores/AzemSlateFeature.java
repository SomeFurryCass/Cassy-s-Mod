...
public class AzemSlateFeature extends OreFeature {
	public static AzemSlateFeature FEATURE = null;
	...
	private static class AzemSlateFeatureRuleTest extends RuleTest {
		static final AzemSlateFeatureRuleTest INSTANCE = new AzemSlateFeatureRuleTest();
		private static final com.mojang.serialization.Codec<AzemSlateFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<AzemSlateFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("foreign_technologies:azem_slate_match"), CUSTOM_MATCH);
		}
