...
public class EtherHighlandsFruitDecorator extends CocoaDecorator {
	public static final EtherHighlandsFruitDecorator INSTANCE = new EtherHighlandsFruitDecorator();
	public static com.mojang.serialization.Codec<EtherHighlandsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ether_highlands_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public EtherHighlandsFruitDecorator() {
		super(0.2f);
	}
