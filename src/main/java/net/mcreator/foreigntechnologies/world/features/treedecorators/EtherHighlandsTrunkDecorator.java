...
public class EtherHighlandsTrunkDecorator extends TrunkVineDecorator {
	public static final EtherHighlandsTrunkDecorator INSTANCE = new EtherHighlandsTrunkDecorator();
	public static com.mojang.serialization.Codec<EtherHighlandsTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ether_highlands_tree_trunk_decorator");
