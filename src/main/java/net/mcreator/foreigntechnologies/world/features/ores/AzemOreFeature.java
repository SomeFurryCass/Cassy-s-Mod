...
public class AzemOreFeature extends OreFeature {
	public static AzemOreFeature FEATURE = null;
	...
	private static class AzemOreFeatureRuleTest extends RuleTest {
		static final AzemOreFeatureRuleTest INSTANCE = new AzemOreFeatureRuleTest();
		private static final com.mojang.serialization.Codec<AzemOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<AzemOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("foreign_technologies:azem_ore_match"), CUSTOM_MATCH);
		}
