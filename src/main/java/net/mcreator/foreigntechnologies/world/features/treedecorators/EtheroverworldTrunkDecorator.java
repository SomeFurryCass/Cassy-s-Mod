...
public class EtheroverworldTrunkDecorator extends TrunkVineDecorator {

	public static final EtheroverworldTrunkDecorator INSTANCE = new EtheroverworldTrunkDecorator();

	public static com.mojang.serialization.Codec<EtheroverworldTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;

	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("etheroverworld_tree_trunk_decorator");
