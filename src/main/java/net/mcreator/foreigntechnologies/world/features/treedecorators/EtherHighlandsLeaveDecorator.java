...
public class EtherHighlandsLeaveDecorator extends LeaveVineDecorator {
	public static final EtherHighlandsLeaveDecorator INSTANCE = new EtherHighlandsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ether_highlands_tree_leave_decorator");
