...
public class KorisOreFeature extends OreFeature {
	public static KorisOreFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new KorisOreFeature();
	...
	private static class KorisOreFeatureRuleTest extends RuleTest {
		static final KorisOreFeatureRuleTest INSTANCE = new KorisOreFeatureRuleTest();
		private static final com.mojang.serialization.Codec<KorisOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<KorisOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("foreign_technologies:koris_ore_match"), CUSTOM_MATCH);
		}
		...
		public boolean test(BlockState blockAt, Random random) {
			if (base_blocks == null) {
				base_blocks = List.of(ForeignTechnologiesModBlocks.ETHERSTONE.get());
			}
