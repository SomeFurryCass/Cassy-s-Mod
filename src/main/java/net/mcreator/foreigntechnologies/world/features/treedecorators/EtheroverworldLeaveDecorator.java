...
public class EtheroverworldLeaveDecorator extends LeaveVineDecorator {
	public static final EtheroverworldLeaveDecorator INSTANCE = new EtheroverworldLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("etheroverworld_tree_leave_decorator");
