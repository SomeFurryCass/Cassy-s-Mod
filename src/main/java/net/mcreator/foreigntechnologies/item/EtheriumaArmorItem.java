...
public abstract class EtheriumaArmorItem extends ArmorItem {
	public EtheriumaArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends EtheriumaArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "foreign_technologies:textures/models/armor/etheriuma_layer_1.png";
		}
	}

	public static class Chestplate extends EtheriumaArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends EtheriumaArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "foreign_technologies:textures/models/armor/etheriuma_layer_2.png";
		}
	}

	public static class Boots extends EtheriumaArmorItem {
		public Boots() {
