...
public class AzemaSwordItem extends SwordItem {
	public AzemaSwordItem() {
		super(new Tier() {
			public int getUses() {
				return 2380;
			}
		...
		}, 3, -2.4000000000000001f, new Item.Properties().tab(ForeignTechnologiesModTabs.TAB_ETHER_TOOLS).fireResistant());
	}
}
