 ...
 *
 */
package net.mcreator.foreigntechnologies;
...
@Mod("foreign_technologies")
public class ForeignTechnologiesMod {
	public static final Logger LOGGER = LogManager.getLogger(ForeignTechnologiesMod.class);
	public static final String MODID = "foreign_technologies";
